...
import pytest
from source_hapi_fhir.source import HapiFhirStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HapiFhirStream, "path", "v0/example_endpoint")
    mocker.patch.object(HapiFhirStream, "primary_key", "test_primary_key")
    mocker.patch.object(HapiFhirStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HapiFhirStream()
