...
class ArtClientViralLoadCollection(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientViralLoadCollection, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('viral-load-collection',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-viral-load-collection", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ExposedInfantMilestoneHivTest(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ExposedInfantMilestoneHivTest, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('milestone-hiv-test',{})
...
class AHDEvaluation(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(AHDEvaluation, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('ahd-evaluation',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-ahd-evaluation", "_count": "200"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ChildrenPresent(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ChildrenPresent, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('children-present',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-children-present", "_count": "200"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
            return params
class ArtClientVitalsFemaleFifteenYearsPlus(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientVitalsFemaleFifteenYearsPlus, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('vitals-female-plus',{})
...
class ArtClientScreening(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientScreening, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('patient-screening',{})
...
class ArtClientClinicalRegistration(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientClinicalRegistration, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('clinical-registration',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-clinical-registration", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ArtClientRecordViralLoadResults(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientRecordViralLoadResults, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('record-vl-results',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-record-viral-load-results", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ArtClientGiveViralLoadResults(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ArtClientGiveViralLoadResults, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('give-vl-results',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/art-client-give-viral-load-results", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ExposedInfantGiveHivTestResults(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ExposedInfantGiveHivTestResults, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('give-hiv-results',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/exposed-infant-give-hiv-test-results", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class ExposedInfantRecordHivTestResults(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(ExposedInfantRecordHivTestResults, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('record-hiv-results',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/exposed-infant-record-hiv-test-results", "_count": "100"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
...
class HivTestAndNextAppt(IncrementalHapiFhirStream, ABC):
    def __init__(self, url: str, **kwargs):
        super(HivTestAndNextAppt, self).__init__(url, **kwargs)
        self.resources_config = resources_config
        self.tags_to_remove = self.resources_config.get('otherResource', [])
        self.link_ids_to_keep = self.resources_config.get('questionnaireResponse',{}).get('hiv-test-next-appt',{})
    ...
    def request_params(
        ...
        if stream_state:
            ...
            params.update(last_updated_date_params)
        if next_page_token is None:
            questionnaire_param = {"questionnaire": "Questionnaire/contact-and-community-positive-hiv-test-and-next-appointment", "_count": "500"}
            params.update(questionnaire_param)
            return params
        else:
            params.update(next_page_token)
