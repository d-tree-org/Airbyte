...
class Customers(HapiFhirStream):
    """
...
class Employees(IncrementalHapiFhirStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
...
class SourceHapiFhir(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        """
        keycloak_openid = KeycloakOpenID(server_url="https://tigathe-auth.d-tree.org/auth/",
                                         client_id=config["client_id"],
                                         realm_name="core-malawi-dev",
...
class Patient(HttpStream):
    ...
    url_base = "https://fhir-dev.d-tree.org/fhir/Patient"
